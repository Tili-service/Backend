...
type Item struct {
	...
	ItemId     uuid.UUID       `bun:"item_id,pk,type:uuid,default:gen_random_uuid()" json:"item_id"      example:"00000000-0000-0000-0000-000000000000"`
	...
	CategorieID uuid.UUID            `bun:"categorie_id,notnull,type:uuid"                json:"categorie_id"       example:"00000000-0000-0000-0000-000000000000"`
...
type ItemUpdate struct {
	...
	CategorieID *uuid.UUID       `json:"categorie_id" example:"00000000-0000-0000-0000-000000000000"`
}
